      ...
      {isOpen && (
        <div className="modal">
          ...
          <div className="modal-content">
              ...
              <button className='close-modal' onClick={closeModal}  style={{borderRadius:'10px', borderColor:'#333'}}>close</button>
            ...
            <div className="modalBody">
              ...
              <div className="modal-body-footer">
                <button className='completed' onClick={closeModal} >Mark as completed</button>
                <button className='delete' onClick={closeModal}>Delete Task</button>
              </div>
            </div>
          </div>
        </div>
